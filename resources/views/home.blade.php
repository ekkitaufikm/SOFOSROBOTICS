  ...
  <div class="container-fluid" data-aos="fade-up">
    <div class="row justify-content-center">
      <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
        ...
        <div><a href="#about" class="btn-get-started scrollto">LEARN MORE</a></div>
      </div>
      <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
        <img src="{{ asset('assets/landing/img/robot/robot3.png')}}" class="img-fluid animated" alt="">
      </div>
    </div>
  </div>
      ...
      <div class="row ">
        ...
        <div class="col-lg-4 col-md-5 offset-md-4">
          <div class="box">
            ...
            <div class="btn-wrap">
              <a href="{{ url('detail1')}}" class="btn-buy">Select</a>
            </div>
          </div>
        </div>
